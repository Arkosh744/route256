...
type CheckoutClient interface {
	AddToCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	DeleteFromCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	ListCart(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*ListCartResponse, error)
	Purchase(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*OrderIDResponse, error)
}
...
func (c *checkoutClient) AddToCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *checkoutClient) DeleteFromCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *checkoutClient) ListCart(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*ListCartResponse, error) {
...
func (c *checkoutClient) Purchase(ctx context.Context, in *OrderIDRequest, opts ...grpc.CallOption) (*OrderIDResponse, error) {
	out := new(OrderIDResponse)
...
type CheckoutServer interface {
	AddToCart(context.Context, *CartRequest) (*empty.Empty, error)
	DeleteFromCart(context.Context, *CartRequest) (*empty.Empty, error)
	ListCart(context.Context, *OrderIDRequest) (*ListCartResponse, error)
	Purchase(context.Context, *OrderIDRequest) (*OrderIDResponse, error)
...
func (UnimplementedCheckoutServer) AddToCart(context.Context, *CartRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutServer) DeleteFromCart(context.Context, *CartRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteFromCart not implemented")
}
func (UnimplementedCheckoutServer) ListCart(context.Context, *OrderIDRequest) (*ListCartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCart not implemented")
}
func (UnimplementedCheckoutServer) Purchase(context.Context, *OrderIDRequest) (*OrderIDResponse, error) {
...
func _Checkout_AddToCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).AddToCart(ctx, req.(*CartRequest))
	}
...
func _Checkout_DeleteFromCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).DeleteFromCart(ctx, req.(*CartRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).ListCart(ctx, req.(*OrderIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Checkout_Purchase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServer).Purchase(ctx, req.(*OrderIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
