...
func RegisterCheckoutHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CheckoutServer) error {
	...
	mux.Handle("POST", pattern_Checkout_AddToCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/route256.checkout.Checkout/AddToCart", runtime.WithHTTPPathPattern("/checkout/v1/addToCart"))
		if err != nil {
	...
	mux.Handle("DELETE", pattern_Checkout_DeleteFromCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/route256.checkout.Checkout/DeleteFromCart", runtime.WithHTTPPathPattern("/checkout/v1/deleteFromCart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Checkout_ListCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/route256.checkout.Checkout/ListCart", runtime.WithHTTPPathPattern("/checkout/v1/listCart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Checkout_Purchase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/route256.checkout.Checkout/Purchase", runtime.WithHTTPPathPattern("/checkout/v1/purchase"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCheckoutHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CheckoutClient) error {
	...
	mux.Handle("POST", pattern_Checkout_AddToCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/route256.checkout.Checkout/AddToCart", runtime.WithHTTPPathPattern("/checkout/v1/addToCart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_Checkout_DeleteFromCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/route256.checkout.Checkout/DeleteFromCart", runtime.WithHTTPPathPattern("/checkout/v1/deleteFromCart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Checkout_ListCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/route256.checkout.Checkout/ListCart", runtime.WithHTTPPathPattern("/checkout/v1/listCart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Checkout_Purchase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/route256.checkout.Checkout/Purchase", runtime.WithHTTPPathPattern("/checkout/v1/purchase"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Checkout_AddToCart_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"checkout", "v1", "addToCart"}, ""))

	pattern_Checkout_DeleteFromCart_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"checkout", "v1", "deleteFromCart"}, ""))

	pattern_Checkout_ListCart_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"checkout", "v1", "listCart"}, ""))

	pattern_Checkout_Purchase_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"checkout", "v1", "purchase"}, ""))
)
